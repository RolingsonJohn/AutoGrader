...
DOCKER_IMAGE = config.get(
    "DOCKER",
    "IMAGE",
    fallback="sandbox:1")  # Added IMAGE

# --- Mail Config ---
AUTHORITY = config.get(
    "AUTHORITY",
    "MAIL",
    fallback="https://login.microsoftonline.com/common")
SCOPES = config.get("SCOPES", "MAIL", fallback=[
                    "https://graph.microsoft.com/Mail.Send"])
CLIENT_ID = config.get(
    "CLIENT_ID",
    "MAIL",
    fallback="57a0f8c5-a6a8-41b6-9a5b-a2b0a518f752")
ENDPOINT = config.get(
    "CLIENT_ID",
    "MAIL",
    fallback="https://graph.microsoft.com/v1.0/me/sendMail")
