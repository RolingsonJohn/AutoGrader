...
def calculate_metrics(human_scores, llm_scores):
    # Asegúrate de que las listas de calificaciones sean arrays de numpy para
    # la facilidad de cálculo
    human_scores = np.array(human_scores)
    llm_scores = np.array(llm_scores)

    # Precisión (Accuracy)
    # En este caso, la precisión puede ser cuando las calificaciones son
    # exactamente iguales
    ...
    # Sesgo: Evaluamos si el modelo tiende a sobrevalorar o subvalorar las
    # calificaciones
...
human_scores = [90, 80, 70, 85, 95, 100, 60,
                75, 88, 92]  # Calificaciones humanas
# Calificaciones asignadas por el LLM
llm_scores = [88, 80, 72, 83, 94, 98, 62, 76, 89, 90]
